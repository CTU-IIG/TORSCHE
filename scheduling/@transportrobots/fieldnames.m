...
% Add NODE properties
Props = {'TransportationTimes' 'EmptyMovingTimes' 'Schedule' Props{:}}; 

% Also return assignable values if needed
if nargout>1,
    
    AsgnVals = {'Matrices with transportation times between each processor the specified robot works ' ...
                'Matrices with transportation times on way back' ...
                'Matrix with schedule of robots' ...
                AsgnVals{:}};
...
%end .. @transportrobots/fieldnames
